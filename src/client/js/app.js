...
var p1=window.canvas.p1;
var p2=window.canvas.p2;
var p3=window.canvas.p3;
var p4=window.canvas.p4;
var p5=window.canvas.p5;
var p6=window.canvas.p6;
var p7=window.canvas.p7;
var p8=window.canvas.p8;
var p9=window.canvas.p9;
var v1=window.canvas.v1;
var v2=window.canvas.v2;
var v3=window.canvas.v3;
var v4=window.canvas.v4;
var f1=window.canvas.f1;
var f2=window.canvas.f2;
var f3=window.canvas.f3;
var f4=window.canvas.f4;
var f5=window.canvas.f5;
var f6=window.canvas.f6;
var f7=window.canvas.f7;
var f8=window.canvas.f8;
var back1=window.canvas.back1;
var back2=window.canvas.back2;
var back=window.canvas.back;
...
function drawFood(food) {
    ...
    console.log(food.foodno);
    if(food.hue>0 && food.hue<50){
    graph.drawImage(f1,food.x - player.x + global.screenWidth / 2,
               food.y - player.y + global.screenHeight / 2,
               20, 35);
}else if(food.hue>49 && food.hue<100){
    graph.drawImage(f2,food.x - player.x + global.screenWidth / 2,
               food.y - player.y + global.screenHeight / 2,
               20, 35);
}else if(food.hue>99 && food.hue<150){
    graph.drawImage(f3,food.x - player.x + global.screenWidth / 2,
               food.y - player.y + global.screenHeight / 2,
               20, 35);
}else if(food.hue>149 && food.hue<200){
    graph.drawImage(f4,food.x - player.x + global.screenWidth / 2,
               food.y - player.y + global.screenHeight / 2,
               20, 35);
}else if(food.hue>199 && food.hue<250){
    graph.drawImage(f5,food.x - player.x + global.screenWidth / 2,
               food.y - player.y + global.screenHeight / 2,
               20, 35);
}else if(food.hue>249 && food.hue<300){
    graph.drawImage(f6,food.x - player.x + global.screenWidth / 2,
               food.y - player.y + global.screenHeight / 2,
               20, 35);
}else if(food.hue>299 && food.hue<330){
    graph.drawImage(f7,food.x - player.x + global.screenWidth / 2,
               food.y - player.y + global.screenHeight / 2,
               20, 35);
}else if(food.hue>329 && food.hue<360){
    graph.drawImage(f8,food.x - player.x + global.screenWidth / 2,
               food.y - player.y + global.screenHeight / 2,
               20, 35);
}else{
    graph.drawImage(f1,food.x - player.x + global.screenWidth / 2,
...
function drawVirus(virus) {
    ...
    graph.drawImage(v3,virus.x - player.x + global.screenWidth / 2,
               virus.y - player.y + global.screenHeight / 2,virus.radius+50,virus.radius+120);

}else  if(virus.vir==4){
    graph.drawImage(v4,virus.x - player.x + global.screenWidth / 2,
               virus.y - player.y + global.screenHeight / 2,virus.radius+50,virus.radius+120);
...
function drawPlayers(order) {
    ...
    for(var z=0; z<order.length; z++)
    {
        ...
        */
        ...
        color1="rgba(255,153,0,0)";
    }else    if(userCurrent.hue>24 && userCurrent.hue <51){
        color="rgba(255,255,0,1)";
        color1="rgba(255,255,0,0)";
    }else    if(userCurrent.hue>60 && userCurrent.hue <141){
        color="rgba(0,128,0,1)";
        color1="rgba(0,128,0,0)";
    }else    if(userCurrent.hue>140 && userCurrent.hue <191){
        color="rgba(0,0,255,1)";
        color1="rgba(0,0,255,0)";
    }else    if(userCurrent.hue>190 && userCurrent.hue <251){
        color="rgba(128,0,128,1)";
        color1="rgba(128,0,128,0)";
    }else    if(userCurrent.hue>340){
        color="rgba(255,0,0,1)";
        color1="rgba(255,0,0,0)";
    }else    if(userCurrent.hue>50 && userCurrent.hue <61){
        color="rgba(128,117,0,1)";
        color1="rgba(128,117,0,0)";
    }else    if(userCurrent.hue>250 && userCurrent.hue <301){
        color="rgba(74,0,128,1)";
        color1="rgba(74,0,128,0)";
    }else    if(userCurrent.hue>300 && userCurrent.hue <341){
        color="rgba(128,0,74,1)";
        color1="rgba(128,0,74,0)";
    }
        gradient.addColorStop(0, color);
        // gradient.addColorStop(0.1, "rgba(0,0,255,0.9)");
        // gradient.addColorStop(0.2, "rgba(0,0,255,0.8)");
        // gradient.addColorStop(0.3, "rgba(0,0,255,0.7)");
        // gradient.addColorStop(0.4, "rgba(0,0,255,0.6)");
        // gradient.addColorStop(0.5, "rgba(0,0,255,0.5)");
        // gradient.addColorStop(0.6, "rgba(0,0,255,0.3)");
        // gradient.addColorStop(0.7, "rgba(0,0,255,0.1)");
        // gradient.addColorStop(0.8, "rgba(0,0,255,0)");
        // gradient.addColorStop(0.9, "rgba(0,0,255,0)");
...
function drawFireFood(mass) {
    ...
    }else    if(currenthue>24 && currenthue <51){
         graph.drawImage(f5,mass.x - player.x + global.screenWidth / 2,
               mass.y - player.y + global.screenHeight / 2,
               mass.radius+5, mass.radius+10);
    }else    if(currenthue>60 && currenthue <141){
         graph.drawImage(f3,mass.x - player.x + global.screenWidth / 2,
               mass.y - player.y + global.screenHeight / 2,
               mass.radius+5, mass.radius+10);
    }else    if(currenthue>140 && currenthue <191){
         graph.drawImage(f1,mass.x - player.x + global.screenWidth / 2,
               mass.y - player.y + global.screenHeight / 2,
               mass.radius+5, mass.radius+10);
    }else    if(currenthue>190 && currenthue <251){
        graph.drawImage(f7,mass.x - player.x + global.screenWidth / 2,
               mass.y - player.y + global.screenHeight / 2,
               mass.radius+5, mass.radius+10);
    }else    if(currenthue>340){
        graph.drawImage(f5,mass.x - player.x + global.screenWidth / 2,
               mass.y - player.y + global.screenHeight / 2,
               mass.radius+5, mass.radius+10);
    }else    if(currenthue>50 && currenthue <61){
         graph.drawImage(f8,mass.x - player.x + global.screenWidth / 2,
               mass.y - player.y + global.screenHeight / 2,
               mass.radius+5, mass.radius+10);
    }else    if(currenthue>250 && currenthue <301){
        graph.drawImage(f6,mass.x - player.x + global.screenWidth / 2,
               mass.y - player.y + global.screenHeight / 2,
               mass.radius+5, mass.radius+10);
    }else    if(currenthue>300 && currenthue <341){
        graph.drawImage(f2,mass.x - player.x + global.screenWidth / 2,
               mass.y - player.y + global.screenHeight / 2,
               mass.radius+5, mass.radius+10);
    }
...
function gameLoop() {
    if (global.died) {
        // graph.fillStyle = graph.createPattern(back2,'repeat');
